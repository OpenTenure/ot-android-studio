...
MERGE INTO CONFIGURATION(CONFIGURATION_ID, NAME, "VALUE") KEY (CONFIGURATION_ID) SELECT '1', 'DBVERSION', '2.0.0' FROM DUAL;
...
FOREIGN KEY (LAND_USE) REFERENCES LAND_USE(CODE),
FOREIGN KEY (CHALLENGED_CLAIM_ID) REFERENCES CLAIM(CLAIM_ID),
FOREIGN KEY (PERSON_ID) REFERENCES PERSON(PERSON_ID),
FOREIGN KEY (TYPE) REFERENCES CLAIM_TYPE(CODE),
