...
UNION
SELECT '1.7.0' as VERSION_FROM, '1.8.0' as VERSION_TO,'upgradedb_1.7.0_1.8.0.sql' as SCRIPT FROM DUAL
UNION
SELECT '1.8.0' as VERSION_FROM, '1.9.0' as VERSION_TO,'upgradedb_1.8.0_1.9.0.sql' as SCRIPT FROM DUAL
UNION
SELECT '1.9.0' as VERSION_FROM, '2.0.0' as VERSION_TO,'upgradedb_1.9.0_2.0.0.sql' as SCRIPT FROM DUAL
UNION
SELECT '2.1.0' as VERSION_FROM, '2.1.0' as VERSION_TO,'upgradedb_2.0.0_2.1.0.sql' as SCRIPT FROM DUAL
)
