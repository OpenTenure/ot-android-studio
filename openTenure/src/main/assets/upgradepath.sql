...
UNION
SELECT '1.8.0' as VERSION_FROM, '1.8.0' as VERSION_TO,'upgradedb_1.7.0_1.8.0.sql' as SCRIPT FROM DUAL
UNION
SELECT '1.9.0' as VERSION_FROM, '1.9.0' as VERSION_TO,'upgradedb_1.8.0_1.9.0.sql' as SCRIPT FROM DUAL
)
